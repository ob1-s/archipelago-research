...
- **Verification.** 397 adapter tests pass (was 378; +19 new), model-free 92 / 15/15 unchanged, `compileall` and `uv build` succeed; artifacts regenerated with `record_hash a0b421f1…`, 21/21 gates, `status=PASS`, `authorized_to_run_h1=false`, zero live calls.
