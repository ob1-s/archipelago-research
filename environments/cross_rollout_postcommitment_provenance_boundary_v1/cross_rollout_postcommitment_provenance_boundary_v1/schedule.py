"""Frozen Phase-1 presentation schedule and stopping rule."""
...
MAX_ATTEMPTS = 1400
TARGET_PRIMARY_ELIGIBLE = 432
SCHEDULE_SEED = (
    "cross-rollout-postcommitment-provenance-boundary-v1-schedule-2026-08-14"
)
