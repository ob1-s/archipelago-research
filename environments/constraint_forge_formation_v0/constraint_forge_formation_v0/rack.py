...
class FilmFrame(StrictModel):
    ...
    remaining_rounds: Annotated[StrictInt, Field(ge=0, le=16)]
    writes_remaining: Annotated[StrictInt, Field(ge=0, le=3)]
    mutations_remaining: Annotated[StrictInt, Field(ge=0, le=8)]
