...
class StationState(MutableStrictModel):
    ...
    writes_remaining: StrictInt = Field(default=3, ge=0, le=3)
    mutations_remaining: StrictInt = Field(default=8, ge=0, le=8)
    finished: StrictBool = False
    finish_round: StrictInt | None = Field(default=None, ge=1, le=16)
...
class InterventionState(StrictModel):
    ...
    trigger_round: StrictInt | None = Field(default=None, ge=1, le=16)
    effect_round: StrictInt | None = Field(default=None, ge=1, le=19)
    detail: StrictStr = ""
...
class PendingWrite(StrictModel):
    ...
    selected_round: Annotated[StrictInt, Field(ge=1, le=16)]
    delivery_round: Annotated[StrictInt, Field(ge=1, le=19)]
    action_id: StrictStr
...
class VisibilitySuppression(StrictModel):
    ...
    selected_round: Annotated[StrictInt, Field(ge=1, le=16)]
    release_round: Annotated[StrictInt, Field(ge=1, le=17)]
...
class WorldState(MutableStrictModel):
    ...
    round: StrictInt = Field(default=1, ge=1, le=16)
    rounds_remaining: StrictInt = Field(default=16, ge=0, le=16)
...
class StateTransition(StrictModel):
    ...
    round: Annotated[StrictInt, Field(ge=1, le=16)]
    station: Station
    action_id: StrictStr
    action_payload: dict
    legal: StrictBool
