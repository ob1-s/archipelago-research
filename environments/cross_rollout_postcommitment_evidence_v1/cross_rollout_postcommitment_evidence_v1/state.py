...
AssignmentMode = Literal["post_b_success_random", "fixed_neutral"]
Eligibility = Literal[
    "pending_phase1",
    "primary_B_success_pass",
    "nonprimary_successful_r1",
...
class EvidenceState(vf.State):
    """All latent, evidence, assignment, and lifecycle fields for one rollout."""
    ...
    assignment_stage: Literal["after_phase1_evidence"] = "after_phase1_evidence"
    ...
    phase: Phase = "phase1"
    phase1_presentation_order: PresentationOrder = "B_first"
