...
from constraint_forge_behavioral_runner_r1.audit import (
    AuditLedger,
    AuditSeal,
    AuditSealStatus,
    AuditStatus,
)
from constraint_forge_behavioral_runner_r1.cohort import (
...
from constraint_forge_behavioral_runner_r1.cohort_launcher import (
...
from constraint_forge_behavioral_runner_r1.handoff import FormationHandoffV0, FormationJobReceipt
...
def test_frozen_cohort_manifest_is_twelve_independent_hash_pinned_dyads() -> None:
    ...
    from constraint_forge_behavioral_runner_r1.schedule import (
        FAULT_INDICES,
        ORDINARY_INDICES,
        PROBE_INDICES,
    )
...
def test_manifest_hash_binds_freeze_commit_provider_and_plans() -> None:
    ...
    assert manifest.protocol_version == "constraint-forge/behavioral-runner-r1"
...
def test_declared_boundary_knobs_reach_the_harness_process_state(monkeypatch) -> None:
    ...
    from constraint_forge_behavioral_runner_r1.harness import text_harness_boundary
    from constraint_forge_behavioral_runner_r1 import cohort_launcher

    from constraint_forge_behavioral_runner_r1.harness import _TEXT_HARNESS_BOUNDARY

    monkeypatch.setattr(
        "constraint_forge_behavioral_runner_r1.harness._TEXT_HARNESS_BOUNDARY", {}
    )
...
def test_luna_qualification_boundary_and_config_are_proxy_local() -> None:
    ...
    from constraint_forge_behavioral_runner_r1.luna_qualification import (
        LUNA_BASE_URL,
        LUNA_MODEL,
        _agent_config,
        _build_task,
