...
environments/constraint_forge_behavioral_runner_r1/docs/phaseA_forensics.md
...
def test_probe_schedule_pairs_contrast_film_conditions():
    ...
    from constraint_forge_behavioral_runner_r1.schedule import build_run_plan
...
def test_preflight_flags_dead_bridge(tmp_path: Path):
    ...
    proc = subprocess.run(
        [
            sys.executable, "-m",
            "constraint_forge_behavioral_runner_r1.cohort_launcher",
