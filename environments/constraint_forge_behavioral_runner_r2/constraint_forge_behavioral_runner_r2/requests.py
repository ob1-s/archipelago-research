...
from constraint_forge_behavioral_runner_r2._r2_world._config import max_rounds
from constraint_forge_behavioral_runner_r2._r2_world.canonical import canonical_bytes, sha256_bytes
from constraint_forge_behavioral_runner_r2._r2_world.models import StrictModel
from constraint_forge_behavioral_runner_r2._r2_world.rack import FilmFrame, RackView
from constraint_forge_behavioral_runner_r2._r2_world.world import Observation
...
class BehavioralRequest(StrictModel):
    ...
    round: StrictInt | None = Field(default=None, ge=1)
    ...
    @classmethod
    def _request_round_within_job(cls, value: int | None) -> int | None:
...
def round_request(
    *,
    ...
    station_note: str | None = None,
) -> BehavioralRequest:
    if station_note is not None and role != "X":
        raise ValueError("station notes are private to station X")
    instructions = model_instructions(role)
    if station_note is not None:
