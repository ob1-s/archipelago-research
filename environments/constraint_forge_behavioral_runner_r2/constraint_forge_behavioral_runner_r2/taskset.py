...
from constraint_forge_behavioral_runner_r2._r2_world.generator import generate_job, validate_job
from constraint_forge_behavioral_runner_r2._r2_world.interventions import InterventionSchedule
from constraint_forge_behavioral_runner_r2._r2_world.models import Seed
...
class ConstraintForgeBehavioralTaskData(vf.TaskData):
    ...
    protocol_version: Literal["constraint-forge/behavioral-runner-r2"] = (
        "constraint-forge/behavioral-runner-r2"
    )
...
class ConstraintForgeBehavioralEnvConfig(vf.EnvConfig):
    ...
    id: StrictStr = "constraint-forge-behavioral-runner-r2"
    taskset: ConstraintForgeBehavioralTasksetConfig = ConstraintForgeBehavioralTasksetConfig(
        id="constraint-forge-behavioral-runner-r2"
    )
