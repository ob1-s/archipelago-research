...
from constraint_forge_behavioral_runner_r2._r2_world.models import JobRecord, Pair

from .r1_physics import r1_void


def _observation_fixture():
    from constraint_forge_behavioral_runner_r2._r2_world.models import RegisterState, Station
    from constraint_forge_behavioral_runner_r2._r2_world.rack import empty_rack, full_rack_view
...
def screen_s5() -> dict:
    from constraint_forge_behavioral_runner_r2._r2_world import world as world_mod
    import inspect
