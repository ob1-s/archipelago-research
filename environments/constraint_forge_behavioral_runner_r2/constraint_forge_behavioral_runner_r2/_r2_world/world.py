...
from ._config import CONFIG, max_rounds
from .actions import (
    FinishAction,
    SetAction,
    UnsetAction,
...
def initial_state(
    ...
    *,
    ...
    return WorldState(
        ...
        x={
            "station": Station.X,
            "private_pairs": job.x_mask,
            "writes_remaining": CONFIG["write_budget"],
            "mutations_remaining": CONFIG["mutation_budget"],
        },
        y={
            "station": Station.Y,
            "private_pairs": job.y_mask,
            "writes_remaining": CONFIG["write_budget"],
            "mutations_remaining": CONFIG["mutation_budget"],
        },
...
def resolve_round(
    ...
    *,
    ...
    if updated.x.finished and updated.y.finished:
        ...
        updated.rounds_remaining = CONFIG["max_rounds"] - current_round
