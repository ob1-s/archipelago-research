"""Typed state and event records for one balanced experiment rollout."""
...
from .constants import Policy, PolicyOrder
...
class BalancedState(vf.State):
    ...
    secondary_phase2_order: PolicyOrder = "K_first"
    ...
    exposure_condition: Condition | None = None
    exposure_text: str = ""
    ...
    stop_reason: str = ""
    events: list[BalancedEvent] = Field(default_factory=list)
