"""Frozen private-evidence and advisory-combination mathematics."""
...
def summarize_evidence(
    ...
    return EvidenceSummary(
        ...
        likelihood_ratio_selected_over_alternative=selected_likelihood / alternative_likelihood,
...
def combined_posterior_selected_fit(
    ...
    combined_lr = private_lr * (1 - advisory_reliability) / advisory_reliability
    return combined_lr / (1 + combined_lr)
